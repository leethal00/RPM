...
export default function Home() {
  ...
  if (!session || !allowed) { router.replace('/login'); return <Loading />; }
  ...
  return <Page><Title detail="Your assigned active jobs">Today</Title>
    ...
    </Card>) : <Card><Text style={styles.muted}>No assigned jobs yet. Ask an RPM administrator to assign jobs to your account.</Text></Card>}
