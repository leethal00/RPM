        ...
        <DashboardLayout>
            <PageShell>
                <PageHeader
                    ...
                    title="Active Jobs"
                    description="Live production jobs, job cards, actual labour and materials, and invoicing progress."
                />
                ...
                <div className="flex items-center gap-2 mb-4">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <Input
                            placeholder="Search job, reference or invoice #…"
                            value={search}
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {jobs.map((job) => {
                                        ...
                                        return (
                                            <tr key={job.id} onClick={() => router.push(`/quoting/${job.id}`)} className="border-t border-border/60 cursor-pointer hover:bg-muted/30">
