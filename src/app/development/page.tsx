...
import { Camera, CheckCircle2, ClipboardList, Clock, ExternalLink, Lightbulb, Loader2, MessageSquare, Smartphone, Sparkles, Timer, Truck, User, Wrench, AlertCircle, MapPinned, FileText } from "lucide-react"
...
const ideas = [
  {
    ...
    status: "Concept",
    icon: Smartphone,
    description: "A phone-first RPM workspace for Rodier installation staff, giving them the site and job information they need without exposing the full administration system.",
    points: ["See today's assigned jobs and sites", "Open site details, contacts and access information", "View construction drawings and other current site documents", "View existing site/job photos", "Take before, progress and completion photos directly into RPM", "Add site notes and completion comments", "Large-button interface designed for use in the field"],
  },
  {
    title: "Installer time & attendance",
    status: "Concept",
    icon: Timer,
    description: "Use the installer app to create an accurate work-day and job time record, including travel and time physically spent on site.",
    points: ["Start work / start travel from the phone", "Confirm arrival and start time at the site", "Confirm finish/departure time", "Separate travel time from on-site labour", "Allocate labour automatically to the correct RPM job", "Feed actual labour into Est vs Actual and later timesheet/payroll workflows"],
  },
  {
    title: "Work-hours location & travel history",
    status: "Concept",
    icon: MapPinned,
    description: "With staff permission and clear work-hours rules, capture location during the working day so RPM can build a useful travel and site-visit record rather than relying on handwritten mileage and times.",
    points: ["Location tracking only while the installer is clocked in / working", "Record travel between allocated sites", "Associate arrival and departure with the relevant site", "Build a daily route and travel history", "Use location as supporting evidence for time records, not as the only clock-in method", "Stop work-location tracking when the work day is finished"],
  },
  {
    title: "Drawings & site information in the field",
    status: "Concept",
    icon: FileText,
    description: "Make RPM the installer’s source for the latest information at each site so drawings and reference material do not need to be found through emails or office folders.",
    points: ["Construction drawings", "Site and asset photos", "Site contacts and access notes", "Job scope and instructions", "Current job documents", "Open everything from the selected site/job on the phone"],
  },
  {
