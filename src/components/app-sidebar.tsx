    ...
    return <Sidebar collapsible="icon" className="border-r border-sidebar-border">
        ...
        <SidebarContent>
            ...
            {!isClientUser && <>
                ...
                <SidebarGroup><SidebarGroupLabel>Job & Project Management</SidebarGroupLabel><SidebarGroupContent><SidebarMenu>{quotingItems.map(item => <SidebarMenuItem key={item.title}><SidebarMenuButton asChild tooltip={item.title} isActive={isQuotingItemActive(item.url)}><Link href={item.url}><item.icon className="size-4" /><span>{item.title}</span></Link></SidebarMenuButton></SidebarMenuItem>)}</SidebarMenu></SidebarGroupContent></SidebarGroup>
            ...
            <SidebarGroup><SidebarGroupLabel>Support</SidebarGroupLabel><SidebarGroupContent><SidebarMenu><SidebarMenuItem><SidebarMenuButton asChild tooltip="Help & Support" isActive={pathname === "/help"}><Link href="/help"><HelpCircle className="size-4" /><span>Help & Support</span></Link></SidebarMenuButton></SidebarMenuItem>{!isClientUser && <><SidebarMenuItem><SidebarMenuButton asChild tooltip="Suggest a feature" isActive={pathname === "/feature-request"}><Link href="/feature-request"><Lightbulb className="size-4" /><span>Suggest a feature</span></Link></SidebarMenuButton></SidebarMenuItem><SidebarMenuItem><SidebarMenuButton asChild tooltip="Feature pipeline" isActive={pathname === "/feature-requests"}><Link href="/feature-requests"><ClipboardList className="size-4" /><span>Feature pipeline</span></Link></SidebarMenuButton></SidebarMenuItem></>}</SidebarMenu></SidebarGroupContent></SidebarGroup>
        </SidebarContent>
