...
export interface Asset { id: string; store_id: string; name: string | null; asset_type_id: string | null; install_date: string | null; last_service_date: string | null; next_service_date: string | null; service_interval_days: number | null; pm_interval_months: number | null; status: string | null; asset_group: string | null; asset_details: string | null; asset_dimensions: string | null; notes: string | null; created_at: string; updated_at: string; asset_types?: AssetType; asset_photos?: AssetPhoto[]; stores?: Store; jobs?: Job[] }
export interface Job { id: string; store_id: string; asset_id: string | null; vendor_id: string | null; project_id: string | null; job_type: JobType; title: string; description: string | null; severity: Severity | null; status: JobStatus; reported_by: string; assigned_to: string | null; resolved_at: string | null; responded_at: string | null; budget_impact: number | null; photos: string[]; media_urls: string[]; created_at: string; updated_at: string; stores?: Store; assets?: Asset; vendors?: Vendor; projects?: Project; reporter?: UserProfile; assignee?: UserProfile }
export interface Project { id: string; name: string; description: string | null; status: string; budget: number; start_date: string | null; end_date: string | null; store_id: string | null; created_by: string | null; created_at: string; updated_at: string; stores?: Store; jobs?: Job[] }
...
export interface CostingTimeEntry { id: string; job_id: string; work_date: string | null; user_id: string | null; person_name: string | null; hours: number; description: string | null; labour_type: string | null; created_by: string | null; created_at: string; updated_at: string }
export interface CostingMaterialActual { id: string; job_id: string; order_date: string | null; supplier: string | null; description: string | null; qty: number | null; cost: number | null; material_id: string | null; created_by: string | null; created_at: string; updated_at: string }
export interface Vendor { id: string; client_id: string | null; name: string; trade: string; email: string | null; phone: string | null; account_code: string | null; status: string; created_at: string; updated_at: string }
